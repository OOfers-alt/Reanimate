...
if Rig == "R6" then
	...
	if Rig == "R6" then
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["Right Arm"].BodyThrust.Location =  game.Players.LocalPlayer.Character.Pillow.Handle.Position
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["Right Arm"].BodyPosition.Position =  game.Players.LocalPlayer.Character.Pillow.Handle.Position
	else
game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name].UpperTorso.CFrame = game.Players.LocalPlayer.Character.Torso.CFrame * CFrame.new(0,0.2,0)
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["HumanoidRootPart"].BodyThrust.Location =  game.Players.LocalPlayer.Character.Pillow.Handle.Position
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["HumanoidRootPart"].BodyPosition.Position =  game.Players.LocalPlayer.Character.Pillow.Handle.Position 
	end
	pcall(function()
		maybe.Handle.CFrame = clone.Handle.CFrame
