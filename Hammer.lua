getgenv().key = game:GetService("RbxAnalyticsService"):GetClientId()
rayKey, rayKey2 = "EqHIusrb4CNs6cB36Ag5", "BXtwHXKKsGl18zvDyb2a" -- Must be same as the one in the env file
SecretNum = 80886803820329740478 -- Must be same as the one in the env file

URI = "https://incognitowhitelist.herokuapp.com/" -- URL of your webserver / you can use repl.it like i did for this example
...
if URI_Data and URI_Data == 'Invalid Key' then
    game:GetService('Players').LocalPlayer:Kick('Please respect our hard work')
    wait(0.4)
    while true do end
   return end
...
if getgenv().key ~= game:GetService("RbxAnalyticsService"):GetClientId()  then
  game:GetService('Players').LocalPlayer:Kick('We have server checks lmao, nice try')
    wait(0.4)
    while true do end
end
...
game.Players.LocalPlayer.Character.MARTILLO.Handle.Transparency = 0
game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name].MARTILLO.Handle.Transparency = 1
				...
				game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["HumanoidRootPart"].CFrame = game.Players.LocalPlayer.Character.MARTILLO.Handle.CFrame * CFrame.new(0,2.6,0) * CFrame.Angles(math.random(1,90),math.random(1,90),math.random(1,90))
...
game.Players.LocalPlayer.Character.MARTILLO.Handle.Transparency = 0
game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name].MARTILLO.Handle.Transparency = 1
				game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["Right Arm"].CFrame = game.Players.LocalPlayer.Character.MARTILLO.Handle.CFrame * CFrame.new(0,2.6,0) * CFrame.Angles(math.random(1,90),math.random(1,90),math.random(1,90))
...
getgenv().Options = {
	["Jitteryness"] = Vector3.new(40,0,0), -- Velocity
	["Jitterless"] = false, -- Very Small Jitter, Smaller Delay
	["Type"] = "Bullet", -- Raw (Simple), Fling, Bullet, Godmode
	["InstantBullet"] = {
	...
	["R15Method"] = "AlignMax", -- Align,AlignMax Or CFrame
	["R6Method"] = "AlignMax", -- Align,AlignMax Or CFrame
...
game.Players.LocalPlayer.Character["MARTILLO"].Handle.AccessoryWeld:Remove()
...
local maybe = char1["MARTILLO"]
local clone = maybe:Clone()
clone.Handle.Transparency =1
clone.Parent = char1
maybe.Parent = game.Workspace
...
local maincolor = BrickColor.new("Instwitutional white")
local cool = maybe
local hitting = false
...
if Rig == "R6" then
	...
	av.Parent = game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["Right Arm"]
else
	local av = Instance.new("BodyAngularVelocity")
	av.AngularVelocity = Vector3.new(999999999999999999999, 999999999999999999999, 999999999999999999999)
	av.P = 999999999999999999999
	av.MaxTorque = Vector3.new(math.huge, math.huge, math.huge)
...
while fon == false do
    task.wait()
	if Rig == "R6" then
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["Right Arm"].BodyThrust.Location =  game.Players.LocalPlayer.Character.MARTILLO.Handle.Position
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["Right Arm"].BodyPosition.Position =  game.Players.LocalPlayer.Character.MARTILLO.Handle.Position
	else
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name].UpperTorso.CFrame = game.Players.LocalPlayer.Character.Torso.CFrame * CFrame.new(0,0.2,0)
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["HumanoidRootPart"].BodyThrust.Location =  game.Players.LocalPlayer.Character.MARTILLO.Handle.Position
		game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Name]["HumanoidRootPart"].BodyPosition.Position =  game.Players.LocalPlayer.Character.MARTILLO.Handle.Position 
	end
	pcall(function()
...
item2 = character2["MARTILLO"].Handle
--item2:BreakJoints()
...
a1.Position = Vector3.new(0, -1, -2.5)
a1.Orientation = Vector3.new(2.50448e-06, -90, 90)
maybe.Handle.Massless = true
